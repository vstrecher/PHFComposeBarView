...
CGFloat const PHFComposeBarViewInitialHeight = 35.0f;
...
- (void)layoutSubviews {
    ...
    self.backgroundColor = [UIColor colorWithRed:204/255.0 green:204/255.0 blue:204/255.0 alpha:1.0] ;
